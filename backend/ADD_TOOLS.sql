...
INSERT INTO internal_tools (namespace, name, qualified_name, description, is_active)
VALUES ('artist', 'list_albums', 'artist:list_albums', 'List albums for an artist with pagination', 1),
...
INSERT INTO persona_tool_access (persona_id, pattern, allow)
VALUES (1, 'artist:*', 1),
       (1, 'album:*', 1),
       (1, 'file:*', 1),
       (1, 'track:*', 1),
