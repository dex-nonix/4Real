...
class StreamingEventManager:
    ...
    def emit_llm_status_event(self, session_id: int, history_id: int, stage: str, message: str,
    ...
    def emit_streaming_error(self, session_id: int, history_id: int, error_message: str,
