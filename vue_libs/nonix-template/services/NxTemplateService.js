...
export default class NxTemplateService extends NxCrudService {
    constructor(app) {
        super(app, 'templates', {
            table: {
                columns: [
                ...
                fields: [
                    {
                        ...
                        label: 'Name',
                        required: true,
                        props: {placeholder: 'Enter template name'}
                    },
                    {
                        key: 'description',
                        type: 'textarea',
                        label: 'Description',
                        required: false,
                        props: {placeholder: 'Enter template description'}
                    },
                    {
                        key: 'content',
                        type: 'textarea',
                        label: 'Content',
                        required: true,
                        props: {placeholder: 'Enter template content'}
                    },
                    {key: 'context', type: 'json', label: 'Context (JSON)', required: false},
                    {
                        ...
                        required: false,
                        props: {entity: 'templates', search: true, placeholder: 'Select a parent template (optional)'}
                    }
                ]
            }
        })
