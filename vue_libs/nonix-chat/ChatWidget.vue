...
async function refreshTools() {
  ...
  try {
    const res = await new (await import('@nonix-chat/services/ChatRuntimeService.js')).default().personaTools(personaId)
...
async function refreshMcp() {
  try {
    const res = await new (await import('@nonix-chat/services/ChatRuntimeService.js')).default().mcpStatus()
