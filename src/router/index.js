...
const routes = [
  ...
  ...CrudPage.createRoutes('ai-providers', { displayMode: 'inline' }, { layout: 'master' }),
  ...CrudPage.createRoutes('ai-model-mappings', { displayMode: 'inline' }, { layout: 'master' }),
  ...CrudPage.createRoutes('ai-analysis-results', { displayMode: 'inline' }, { layout: 'master' }),
