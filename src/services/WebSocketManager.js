// Simple WebSocket Manager - just works, no bullshit
import { ref } from 'vue'
...
export default class WebSocketManager {
  ...
  // Simple event handlers - no complex state machines
  ...
  // Simple room management - use Socket.IO native features
  joinRoom(room) {
  ...
  // Simple event handling - use Socket.IO native features
  on(event, callback) {
    if (!this.socket) return () => {}
