...
class SessionResponse(SessionBase, BaseDBMixin):
    pass
...
class MessageResponse(MessageBase, BaseDBMixin):
    pass
...
class HistoryResponse(HistoryBase, BaseDBMixin):
    pass
...
class PersonaChatResponse(PersonaBase, BaseDBMixin):
    pass
