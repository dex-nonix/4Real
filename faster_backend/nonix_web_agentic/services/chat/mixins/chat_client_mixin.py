...
class ToolExecutionMixin(WebSocketMixinProtocol):
    ...
    agentic_plugin:NxWebAgenticPlugin = InjectPlugin(NxWebAgenticPlugin)

    async def run_chat_streaming(self, provider: Any, mapping: Any,
        ...
        try:
            ...
            if available_tools_info is not None:
                langchain_tools = self.agentic_plugin.create_langchain_tools(persona_id, available_tools_info
                                                                             )
