from nonix_web_db.crud import CRUDConfig, FilterConfig, SortingConfig, ValidationConfig, SelectorConfig, \
    BaseCrudService
from ..routers.internal_tool.internal_tool_schemas import InternalToolCreate, InternalToolUpdate, InternalToolInDbModel
from ..models.internal_tool import InternalTool


class InternalToolService(BaseCrudService):
    config = CRUDConfig(
        model=InternalTool,
